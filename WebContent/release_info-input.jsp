...
function amazing(){
    ...
    <body>
    	...
    	<form id="goodform" class="layui-form" action="release_info.jsp" method="get" style="width:40%;margin:auto;margin-top:20px;">
			<div class="layui-form-item">
				<label class="layui-form-label">商品名称</label>
				<div class="layui-inline" style="width:67%;">
					<input id="goodname" type="text" oninput="checkname()" name="goodname" class="layui-input"/>
				</div>
    		...
    		<div class="layui-form-item">
				...
				<div class="layui-inline">
					<input id="price" type="text" name="price" oninput="checkprice()" class="layui-input"/>
				</div>
				<label class="tip"></label>
			</div>
			<div class="layui-form-item" style="width:75%;">
				...
				<div class="layui-inline" style="width:39%;">
					<input id="num" type="text" name="num" oninput="checknum()" class="layui-input" style="width: 100%;"/>
				</div>
				<label class="tip"></label>
			</div>
			<div class="layui-form-item">
			...
			<div class="layui-form-item">
				...
				<div class="layui-inline" style="width:67%;">
					<input id="freight" type="text" name="freight" oninput="checkfreight()" class="layui-input"/>
				</div>
				<label class="tip"></label>
			</div>
			<div class="layui-form-item">
				...
				<div class="layui-inline" style="width:67%;">
					<textarea rows="20" cols="67" id="des" name="description" oninput="checkdes()" class="layui-input" style="height:200px;"></textarea>
				</div>
				<label class="tip"></label>
			</div>
			<div class="layui-form-item">
